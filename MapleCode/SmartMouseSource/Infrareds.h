...
#define LEFTREARIR INFRARED_TWO_PIN
#define FRONTLEFTIR INFRARED_THREE_PIN
#define FRONTRIGHTIR INFRARED_FOUR_PIN
#define RIGHTFRONTIR INFRARED_FIVE_PIN
#define RIGHTREARIR INFRARED_SIX_PIN
